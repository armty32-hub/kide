...
const GAMES_DATA = [
    ...
    },
    {
        ...
        color: "#059669",
        age: "3-6 ขวบ",
        desc: "ฝึกสะกดคำพยัญชนะไทยครบ 44 ตัว (ก-ฮ) ผสมสระพื้นฐาน พร้อมเสียงอ่านออกเสียงชัดเจน",
    ...
    {
        id: "coloring-canvas",
        title: "สตูดิโอระบายสีอัจฉริยะ (16 รูปภาพ)",
        category: "creativity",
        categoryName: "🎵 ดนตรี & ศิลปะ",
        emoji: "🎨",
        color: "#e84393",
        age: "2-7 ขวบ",
        desc: "เลือกได้ 16 รูปภาพ! รองรับทั้งแตะลงสี (เทสี) และพู่กันระบายอิสระ ปากกาดาววิบวับ สติกเกอร์ และบันทึกรูปภาพได้",
